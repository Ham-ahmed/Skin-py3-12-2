...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Skin-py3-12-2/main/YouViX-Skin6_5_003-PosterX_4x1-Mod-HA.tar.gz"
wait
tar -xzf YouViX-Skin6_5_003-PosterX_4x1-Mod-HA.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/YouViX-Skin6_5_003-PosterX_4x1-Mod-HA.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
