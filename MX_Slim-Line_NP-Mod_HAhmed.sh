...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Skin-py3-12-2/main/MX_Slim-Line_NP-Mod.tar.gz"
wait
tar -xzf MX_Slim-Line_NP-Mod.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/MX_Slim-Line_NP-Mod.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
