...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Skin-py3-12-2/main/estuaryfhd-posterX-mod3_H-Ahmed.tar.gz"
wait
tar -xzf estuaryfhd-posterX-mod3_H-Ahmed.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/estuaryfhd-posterX-mod3_H-Ahmed.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
